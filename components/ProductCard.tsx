...
export function ProductCard({ product, index = 0 }: { product: Product; index?: number }) {
  return (
    <Link
      className="group block overflow-hidden border border-cream/20 bg-surface transition duration-200 hover:-rotate-1 hover:border-accent hover:shadow-[8px_8px_0_rgba(255,90,31,0.35)]"
    ...
    >
      ...
      <div className="space-y-4 p-4">
        <div>
          ...
          <h3 className="mt-2 text-2xl font-black leading-none tracking-tight text-cream">
            {product.name}
          </h3>
